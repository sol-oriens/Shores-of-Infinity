...
tidy class BonusEffect : Hook, IPickupHook, IAnomalyHook, ISiteHook, IAbilityHook, IConstructionHook, IRandomOptionHook {
	...
	//For use as a site hook
	void init(SiteType@ type) {}
	void choose(Site@ site, Empire@ emp) const override { activate(site.obj, emp); }
	bool giveOption(Site@ site, Empire@ emp) const override { return true; }
